...
ALTER TABLE ORDERS ADD CONSTRAINT fk_orders1 FOREIGN KEY (Customer_Id) REFERENCES CUSTOMER(Customer_Id) 

ALTER TABLE ORDERS ADD CONSTRAINT fk_orders2 FOREIGN KEY (Product_Id) REFERENCES PRODUCT(Product_Id) 
